...
var mcu2=0;var observer2 = new MutationObserver(e => { e.forEach(({ addedNodes: e }) => { e.forEach(e => {1 === e.nodeType && "SCRIPT" === e.tagName && ((e.src.includes("axon-shop-integratio")||e.src.includes("/assets/core.min.js"))&&(e.setAttribute("data-src", e.src), e.removeAttribute("src"), (function () { mcu2++;if(mcu2==2){observer2.disconnect();} })()))})})});observer2.observe(document.documentElement,{childList:!0,subtree:!0})

if ( window.location.pathname === '/' || window.location.pathname.includes("/products/")) {var mcu=0;var observer = new MutationObserver(e => { e.forEach(({ addedNodes: e }) => { e.forEach(e => {1 === e.nodeType && "SCRIPT" === e.tagName && ((e.src.includes("https://widget.gotolstoy.com/we/widget.js")||e.src.includes("https://widget.gotolstoy.com/widget/widget.js")||e.src.includes("https://play.gotolstoy.com/widget-v2/widget.js")||e.src.includes("instant-core.min.js"))&&(e.setAttribute("data-mysrc", e.src), e.removeAttribute("src"),mcu++,4==mcu&&observer.disconnect()))})})});observer.observe(document.documentElement,{childList:!0,subtree:!0})
